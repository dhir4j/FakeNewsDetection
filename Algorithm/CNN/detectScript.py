...
model = load_model('/home/dhir4j/code/flask/FND/testing/CNN/fake_news_detector_CNN.keras')
with open('/home/dhir4j/code/flask/FND/testing/CNN/tokenizer.pkl', 'rb') as f:  # Assuming tokenizer.pkl is in the same directory
